...
export const EDITORIAL_POOL: EditorialEntry[] = [
	...
	},
	{
		...
		description: 'Ângulo editorial sobre espaço, rotina e visual do fogão 4 bocas na cozinha moderna.',
		kind: 'Blog',
		flow: 3,
		editorialLabel: 'Editorial · Cozinha moderna',
		topics: ['fogao-4-bocas', 'cozinha-pequena', 'cozinha-moderna'],
		anchorText: 'artigo sobre quando o fogão 4 bocas ainda vale a pena',
		teaser: 'por que ele funciona tão bem em cozinhas compactas e atuais',
		weight: 6,
	},
	{
