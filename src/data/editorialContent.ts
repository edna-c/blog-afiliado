...
export const EDITORIAL_POOL: EditorialEntry[] = [
	...
	},
	{
		...
		title: 'Melhor fogão 5 bocas (ranking de compra)',
		description: 'Ranking atualizado: Electrolux FE5IG, Brastemp BFS5NCR e Consul CFS5NAB — para quem cada um serve e onde ver o preço.',
		kind: 'Guia',
		flow: 2,
		editorialLabel: 'Ranking',
		topics: ['fogao-5-bocas', 'compra-segura', 'custo-beneficio'],
		anchorText: 'ranking de fogão 5 bocas',
		teaser: 'ranking dos 3 melhores fogões 5 bocas com perfil de compra',
		weight: 9,
	},
	{
